...
$lang = array_merge($lang, array(
	...
	'EMAIL_PACKAGE_SIZE_EXPLAIN'	=> 'This setting is applied to the internal message queue. It is the maximum number of e-mails sent out in one package, as well as the maximum total number of e-mails sent out in multiple packages within one hour. Each e-mail could have up to 50 recipients. If it is set to 0, all e-mails would be sent out in one package.',
